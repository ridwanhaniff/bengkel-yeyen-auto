/* =======================================================================
   PRESISI AUTOWORKS — business configuration
   -----------------------------------------------------------------------
   ...
   "Presisi Autoworks" is a fictional demo business used to showcase this
   ...
   ======================================================================= */
const business = {
  name: "Presisi Autoworks",                                  // DEMO
  shortName: "Presisi",
  tagline: "Body Repair • Cat Mobil • Detailing",
  city: "Cirebon",
  region: "Jawa Barat",
  addressLine: "Jl. Tuparev No. 45, Kedawung",                 // DEMO
  postalCode: "45153",                                         // DEMO
  country: "ID",
  phoneDisplay: "0831-3622-3394",
  phoneE164: "+6283136223394",
  whatsapp: "6283136223394",                                   // update to the real business WhatsApp number
  email: "halo@presisiautoworks.id",                            // DEMO
  openingHours: "Senin–Sabtu, 08.00–17.00",
  closedNote: "Minggu tutup",
  googleRating: 4.8,        // (DEMO) replace with real Google Business Profile rating
  ...
  googleMapsUrl: "https://www.google.com/maps/search/?api=1&query=Presisi+Autoworks+Cirebon",
  googleReviewsUrl: "https://www.google.com/search?q=Presisi+Autoworks+Cirebon+reviews",
  mapEmbedSrc: "https://www.google.com/maps?q=Cirebon,Jawa+Barat&z=14&output=embed",
  lat: -6.7063,
  lng: 108.5570,
...
const IMAGE_SOURCES = {
  hero:      {src:"https://images.unsplash.com/photo-1727893304219-063d142ce6f3?auto=format&fit=crop&w=1600&q=80", source:"https://unsplash.com/photos/rU_bvNfr8pQ", alt:"Teknisi mengerjakan bodi mobil di bengkel"},
  ...
  about:     {src:"https://images.unsplash.com/photo-1746079074615-6c01efbff5d4?auto=format&fit=crop&w=900&q=80", source:"https://unsplash.com/photos/wT4-TH8kQDE", alt:"Teknisi bekerja di area bengkel"},
};
